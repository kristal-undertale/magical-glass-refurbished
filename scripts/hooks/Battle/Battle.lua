...
-- Can insert "simple" in the 'exact' argument to use simplified damage
...
function Battle:onVictory()
    ...
    -- Prevent adding dark money and add light money instead
