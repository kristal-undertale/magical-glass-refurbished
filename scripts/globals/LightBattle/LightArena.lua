...
function LightArena:init(x, y, shape)
    ...
    self.sprite_border = LightArenaSprite(self)
        ...
        if #Utils.getPolygonEdges(self.shape) == 4 then
            if i % 4 == 1 then
                if self.height % 2 == 0 then
                    ...
                    table.insert(self.collider.colliders, LineCollider(self, v[1][1] - 1, v[1][2], v[2][1], v[2][2]))
                end
            elseif i % 4 == 2 then
                table.insert(self.collider.colliders, LineCollider(self, v[1][1] + 1, v[1][2] - 1, v[2][1] + 1, v[2][2] + 1))
            elseif i % 4 == 3 then
                ...
                if self.width % 2 == 0 then
                    ...
                    table.insert(self.collider.colliders, LineCollider(self, v[1][1], v[1][2], v[2][1], v[2][2] - 1))
                end
            end
        else
